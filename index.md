...
> Last updated: 2026-09-01 | Total pages: 812
...
- [Connector Routing](docs/ixopay/api/provisioning/connector-routing.md) — Provisioning API  Connector Routing
...
- [Get multi-method routing](docs/ixopay/api/provisioning/get-connector-multi-method-routing.md) — Provisioning API  Connector Routinghttps://documentation.ixopay.com/api/provisioning/connector-routing  Get multi-method routing
- [Get routing](docs/ixopay/api/provisioning/get-connector-routing.md) — Provisioning API  Connector Routinghttps://documentation.ixopay.com/api/provisioning/connector-routing  Get routing
...
- [List routing constraints](docs/ixopay/api/provisioning/list-routing-constraints.md) — Provisioning API  Connector Routinghttps://documentation.ixopay.com/api/provisioning/connector-routing  List routing constraints
...
- [Set multi-method routing](docs/ixopay/api/provisioning/set-connector-multi-method-routing.md) — Provisioning API  Connector Routinghttps://documentation.ixopay.com/api/provisioning/connector-routing  Set multi-method routing
- [Set routing](docs/ixopay/api/provisioning/set-connector-routing.md) — Provisioning API  Connector Routinghttps://documentation.ixopay.com/api/provisioning/connector-routing  Set routing
...
- [Connector routing](docs/ixopay/reference/features/provisioning/connector-routing.md) — Connector routing
- [Rule conditions](docs/ixopay/reference/features/provisioning/connector-routing/conditions.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditions
- [AmountCurrency](docs/ixopay/reference/features/provisioning/connector-routing/conditions/amount-currency.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [BinRangeRegexp](docs/ixopay/reference/features/provisioning/connector-routing/conditions/bin-range-regexp.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [ChargebackCountOrVolumePerConnector](docs/ixopay/reference/features/provisioning/connector-routing/conditions/chargeback-count-or-volume-per-connector.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditCardTokenType](docs/ixopay/reference/features/provisioning/connector-routing/conditions/credit-card-token-type.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinCountry](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-country.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinLevel](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-level.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinLookupStatus](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-lookup-status.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinPrepaid](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-prepaid.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinReloadable](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-reloadable.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinSegment](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-segment.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardBinType](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-bin-type.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardCardNetwork](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-card-network.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CreditcardType](docs/ixopay/reference/features/provisioning/connector-routing/conditions/creditcard-type.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [Currency](docs/ixopay/reference/features/provisioning/connector-routing/conditions/currency.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CustomerCountry](docs/ixopay/reference/features/provisioning/connector-routing/conditions/customer-country.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [CustomerIpCountry](docs/ixopay/reference/features/provisioning/connector-routing/conditions/customer-ip-country.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [DebitPreauthCountOrVolumePerConnector](docs/ixopay/reference/features/provisioning/connector-routing/conditions/debit-preauth-count-or-volume-per-connector.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [ExtraData](docs/ixopay/reference/features/provisioning/connector-routing/conditions/extra-data.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [HasReferenceSchemeTransactionId](docs/ixopay/reference/features/provisioning/connector-routing/conditions/has-reference-scheme-transaction-id.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [IbanRegexp](docs/ixopay/reference/features/provisioning/connector-routing/conditions/iban-regexp.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [IbanRoutingRule](docs/ixopay/reference/features/provisioning/connector-routing/conditions/iban-routing-rule.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [InitialAdapter](docs/ixopay/reference/features/provisioning/connector-routing/conditions/initial-adapter.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [InitialConnector](docs/ixopay/reference/features/provisioning/connector-routing/conditions/initial-connector.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [IsRecurring](docs/ixopay/reference/features/provisioning/connector-routing/conditions/is-recurring.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [RandomLoadBalancer](docs/ixopay/reference/features/provisioning/connector-routing/conditions/random-load-balancer.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [RiskScore](docs/ixopay/reference/features/provisioning/connector-routing/conditions/risk-score.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [TransactionType](docs/ixopay/reference/features/provisioning/connector-routing/conditions/transaction-type.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Rule conditionshttps://documentation.ixop...
- [Routing examples](docs/ixopay/reference/features/provisioning/connector-routing/examples.md) — Connector routinghttps://documentation.ixopay.com/docs/reference/features/provisioning/connector-routing  Routing examples
...
- [Snowflake Integration](docs/ixopay/modules/payments-intelligence/data-pipelines/snowflake.md) — Data Pipelines  Snowflake Integration
- [Unified Reports](docs/ixopay/modules/payments-intelligence/data-pipelines/unified-reports.md) — Data Pipelines  Unified Reports
- [Adyen](docs/ixopay/modules/payments-intelligence/integrations/adyen.md) — Adyen  is a leading global payment platform that provides businesses with a seamless way to accept payments online, in-app, and in-store. Known for...
- [Barclaycard](docs/ixopay/modules/payments-intelligence/integrations/barclaycard.md) — Barclaycard  is a UK-based payment processing provider and part of Barclays, serving hundreds of thousands of businesses across various industries....
- [Braintree](docs/ixopay/modules/payments-intelligence/integrations/braintree.md) — Braintree  is a full-stack payment platform that simplifies online and mobile payments for businesses. Acquired by PayPal in 2013, Braintree enable...
- [Chargebee](docs/ixopay/modules/payments-intelligence/integrations/chargebee.md) — Chargebee  is a subscription management and recurring billing platform that helps businesses automate invoicing, payments, and revenue operations....
- [Chase Payment Tech](docs/ixopay/modules/payments-intelligence/integrations/chase.md) — Chase Payment Tech
- [Checkout.com](docs/ixopay/modules/payments-intelligence/integrations/checkout.md) — Checkout.com  is a leading global payment processing platform that enables businesses to accept, process, and manage payments with ease. Offering a...
- [Getting Started](docs/ixopay/modules/payments-intelligence/integrations/getting-started.md) — Getting Started
- [IXOPAY](docs/ixopay/modules/payments-intelligence/integrations/ixopay.md) — IXOPAY  is a leading payment orchestration platform that streamlines global online payments for enterprise-level businesses. Designed for scalabili...
- [Stripe App Marketplace](docs/ixopay/modules/payments-intelligence/marketplace-integrations/stripe-marketplace.md) — Marketplace Integrations  Stripe App Marketplace
- [AI Co-Pilot](docs/ixopay/modules/payments-intelligence/observability/ai-copilot.md) — AI Co-Pilot
- [Alerts](docs/ixopay/modules/payments-intelligence/observability/alerts.md) — The IXOPAY Payments Intelligence formerly Congrify platform enhances your payments awareness and decision-making through customizable real-time ale...
...
- [Data Explorer](docs/ixopay/modules/payments-intelligence/observability/data-explorer.md) — Data Explorer
...
- [Transaction Search](docs/ixopay/modules/payments-intelligence/observability/transaction-search.md) — Transaction Search
...
- [How to Start](docs/ixopay/modules/payments-intelligence/platform/platform-onboarding.md) — How to Start
