...
tags:
- ixopay-retain-expire-cvvs-https-documentation-ixopay-com-modules-docs-tokenex-cvv-retention-retrieval-overview-direct-link-ixopay-retain-expire-cvvs
- cvv-retention-work-pci-token-services-api-https-documentation-ixopay-com-modules-docs-tokenex-cvv-retention-retrieval-pci-token-services-direct-link-cvv-retention-work-pci-token-services-api
- cvv-retention-work-transparent-gateway-https-documentation-ixopay-com-modules-docs-tokenex-cvv-retention-retrieval-transparent-gateway-direct-link-cvv-retention-work-transparent-gateway
- cvv-retention-work-payment-services-https-documentation-ixopay-com-modules-docs-tokenex-cvv-retention-retrieval-payment-services-direct-link-cvv-retention-work-payment-services
- api
- pci
- tokenex
- ixopay
...
## How does IXOPAY retain and expire CVVs?[​](https://documentation.ixopay.com/modules/docs/tokenex/cvv-retention-retrieval#overview "Direct link to How does IXOPAY retain and expire CVVs?")
...
## How does CVV retention work in the PCI Token Services API?[​](https://documentation.ixopay.com/modules/docs/tokenex/cvv-retention-retrieval#pci-token-services "Direct link to How does CVV retention work in the PCI Token Services API?")
...
## How does CVV retention work in the Transparent Gateway?[​](https://documentation.ixopay.com/modules/docs/tokenex/cvv-retention-retrieval#transparent-gateway "Direct link to How does CVV retention work in the Transparent Gateway?")
...
## How does CVV retention work in Payment Services?[​](https://documentation.ixopay.com/modules/docs/tokenex/cvv-retention-retrieval#payment-services "Direct link to How does CVV retention work in Payment Services?")
