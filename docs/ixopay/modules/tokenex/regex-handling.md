...
tags:
- ixopay-regular-expressions-https-documentation-ixopay-com-modules-docs-tokenex-regex-handling-overview-direct-link-ixopay-regular-expressions
- tools-recommended-building-regexes-https-documentation-ixopay-com-modules-docs-tokenex-regex-handling-recommended-tools-direct-link-tools-recommended-building-regexes
- some-regex-examples-common-cases-https-documentation-ixopay-com-modules-docs-tokenex-regex-handling-examples-direct-link-some-regex-examples-common-cases
...
## How does IXOPAY use regular expressions?[​](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#overview "Direct link to How does IXOPAY use regular expressions?")
...
## What tools are recommended for building regexes?[​](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#recommended-tools "Direct link to What tools are recommended for building regexes?")
...
## What are some regex examples for common use cases?[​](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#examples "Direct link to What are some regex examples for common use cases?")
...
### Payment Services[​](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#payment-services "Direct link to Payment Services")
  ...
  * [How does IXOPAY use regular expressions?](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#overview)
  * [What tools are recommended for building regexes?](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#recommended-tools)
  * [What are some regex examples for common use cases?](https://documentation.ixopay.com/modules/docs/tokenex/regex-handling#examples)
