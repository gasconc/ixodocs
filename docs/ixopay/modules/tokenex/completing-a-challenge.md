...
Requestors have 30 seconds from receiving a challenged Authentications response to initiate a challenge request. If a Requestor does not intend to execute a challenge, the requestor should [abandon the challenge](https://documentation.ixopay.com/modules/docs/tokenex/challenge-abandonment).
Last updated on **Apr 10, 2026**
[Previous 3DS Device Fingerprinting](https://documentation.ixopay.com/modules/docs/tokenex/3-d-secure-device-fingerprinting)[Next Brand Specific Guidelines](https://documentation.ixopay.com/modules/docs/tokenex/3ds-brand-specific-guidelines)
  * [Authentications Request and Response](https://documentation.ixopay.com/modules/docs/tokenex/completing-a-challenge#authentications-request-and-response)
  * [Challenge Request](https://documentation.ixopay.com/modules/docs/tokenex/completing-a-challenge#challenge-request)
  * [Challenge Response](https://documentation.ixopay.com/modules/docs/tokenex/completing-a-challenge#challenge-response)
  * [Retrieving Challenge Results](https://documentation.ixopay.com/modules/docs/tokenex/completing-a-challenge#retrieving-challenge-results)
  * [Handling Timeouts](https://documentation.ixopay.com/modules/docs/tokenex/completing-a-challenge#handling-timeouts)
