...
Last updated on **Apr 10, 2026**
[Previous Encrypt Function](https://documentation.ixopay.com/modules/docs/tokenex/encrypt-function)[Next Use Network Token Function](https://documentation.ixopay.com/modules/docs/tokenex/use-network-token-function)
Send Feedback
Send Feedback
  * [](https://documentation.ixopay.com/modules/)
  * Transparent Gateway API v2
