...
Last updated on **Apr 10, 2026**
[Previous Get Card Metadata](https://documentation.ixopay.com/modules/docs/tokenex/get-card-metadata)[Next Lifecycle Management](https://documentation.ixopay.com/modules/docs/tokenex/lifecycle-management)
Send Feedback
Send Feedback
  * [](https://documentation.ixopay.com/modules/)
  * Network tokenization
