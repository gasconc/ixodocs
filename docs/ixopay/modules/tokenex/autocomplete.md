...
This will set the data element autocomplete attribute to: cc-number and the cvv field to cc-csc. For use with cvv only mode, the only data element is cc-csc.
Last updated on **Apr 10, 2026**
[Previous Detokenization Configuration](https://documentation.ixopay.com/modules/docs/tokenex/detokenize)[Next Putting It All Together](https://documentation.ixopay.com/modules/docs/tokenex/putting-it-all-together)
Send Feedback
Send Feedback
  * [](https://documentation.ixopay.com/modules/)
  * TokenEx iFrame
