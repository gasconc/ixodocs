...
| origin  | string  | comma separated list of fully qualified [Origin](https://developer.mozilla.org/en-US/docs/Web/Security/Same-origin_policy) in the [ancestor](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/frame-ancestors) chain  |  <https://mysite.com>   
...
Last updated on **Apr 10, 2026**
[Previous Creating the iFrame](https://documentation.ixopay.com/modules/docs/tokenex/creating-the-iframe)[Next Nested iFrames](https://documentation.ixopay.com/modules/docs/tokenex/nested-iframes)
Send Feedback
Send Feedback
  * [](https://documentation.ixopay.com/modules/)
  * TokenEx iFrame
