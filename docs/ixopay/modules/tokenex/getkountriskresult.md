...
On this page
# Get Kount Risk Result
**URI:** <https://test-api.tokenex.com/FraudServices.svc/REST/GetKountRiskResult>
...
Last updated on **Apr 10, 2026**
[Previous Get Kount Hash Value and Tokenize](https://documentation.ixopay.com/modules/docs/tokenex/get-kount-hash-value-and-tokenize-1)[Next General Overview](https://documentation.ixopay.com/modules/docs/tokenex/general-overview)
