...
Last updated on **Apr 10, 2026**
[Previous Tokenize](https://documentation.ixopay.com/modules/docs/tokenex/tokenize)[Next ValidateToken](https://documentation.ixopay.com/modules/docs/tokenex/validate-token)
Send Feedback
Send Feedback
  * [](https://documentation.ixopay.com/modules/)
  * TokenEx API v1
