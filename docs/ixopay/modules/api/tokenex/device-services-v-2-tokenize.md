...
tx-dual-decryption — header
--- true false
tx-include-track-details — header
--- true false
tx-use-pin-variant — header
--- true false
Body
  * Example (from schema)
  * Request Example
...
Last updated on **Apr 10, 2026**
[Previous Device Services (P2PE)](https://documentation.ixopay.com/modules/api/tokenex/device-services-p-2-pe)[Next TokenizeEMV](https://documentation.ixopay.com/modules/api/tokenex/device-services-v-2-tokenizeemv)
  * [](https://documentation.ixopay.com/modules/)
  * TokenEx
  * TokenEx API v2
  * [Device Services (P2PE)](https://documentation.ixopay.com/modules/api/tokenex/device-services-p-2-pe)
