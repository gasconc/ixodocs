---
title: Toms
summary: According to Article 32 of the General Data Protection Regulation "GDPR"
  and taking into account the state of the art, the implementation costs and the type,
  the scope, the circumstances and purposes of the processing and the different likelihood
  and severity of the risk to the rights and freedoms o
tags:
- preamble
- general-organisational-measures
- pseudonymisation-encryption-art-par-lit-gdpr
- confidentiality-integrity-art-par-lit-gdpr
- availability-resilience-processing-art-par-lit-gdpr
- testing-assessing-evaluating-art-par-lit-gdpr
- tls
- ixopay
- authorization
- congrify
