Send Feedback
  * [](https://documentation.ixopay.com/manual/)
...
One of the first blocks within the Payment Selection Template is the `<style>` block followed by **CSS3 variables**. Change the colors to fit your desired layout of the template.
...
![Customer Profile Options](https://documentation.ixopay.com/manual/assets/ideal-img/customer-profile-options.77c1926.1280.png)Customer Profile Options
Last updated on **Apr 10, 2026**
[Previous Multi-Method Connector](https://documentation.ixopay.com/manual/docs/connector/multi-method-connector)[Next Meta-Connector - Routing - Cascading - Balancing - Fallback](https://documentation.ixopay.com/manual/docs/connector/routing-cascading-balancing-fallback)
