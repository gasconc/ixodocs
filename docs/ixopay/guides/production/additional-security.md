...
Date header
`Mon, 06 Jul 2026 07:48:00 GMT`
Request URI
`/api/v3/transaction/YOUR-API-KEY-HERE/debit`
Hash HMAC Input
Based on your input, _note the line breaks_.
`POSTcf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3eapplication/json; charset=utf-8Mon, 06 Jul 2026 07:48:00 GMT/api/v3/transaction/YOUR-API-KEY-HERE/debit`
Expected signature
Data is hashed using _HMAC-SHA512_ , and the resulting binary encoded using _Base64_.
`v9eJmqW/yb+QDWEctkmKekXlo9CweMeMtH2NJe6zjSJ13MhqkvTWCaiHrv8++8FNUjTJEuWGn2PEmMaaCcnEMQ==`
Expected headers
`X-Signature: **v9eJmqW/yb+QDWEctkmKekXlo9CweMeMtH2NJe6zjSJ13MhqkvTWCaiHrv8++8FNUjTJEuWGn2PEmMaaCcnEMQ==**  
