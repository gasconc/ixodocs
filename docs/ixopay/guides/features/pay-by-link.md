---
title: Pay-by-Link
summary: The Pay-by-Link feature offers a seamless, almost no-code integration for
  creating secure payment links. Pay-by-Links can be shared with customers through
  various channels, such as email integrated with the IXOPAY platformhttps://www.ixopay.com,
  or others using a third-party provider for example SMS
tags:
- step-creating-pay-link-https-documentation-ixopay-com-docs-guides-features-pay-link-step-creating-pay-link-direct-link-step-creating-pay-link
- step-pay-link-https-documentation-ixopay-com-docs-guides-features-pay-link-step-pay-link-direct-link-step-pay-link
- present-paybylink-customer
- api
- json
- ixopay
- psp
