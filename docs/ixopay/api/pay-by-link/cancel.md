...
Base URL
Edit
https://gateway.ixopay.com/api/v3/payByLink
Auth
Username
Password
Parameters
...
payByLinkId — pathrequired
Last updated on **Apr 10, 2026**
[Previous Introduction](https://documentation.ixopay.com/api/pay-by-link/pay-by-link-api)[Next Enterprise](https://documentation.ixopay.com/api/enterprise)
  * [](https://documentation.ixopay.com/)
  * Pay-by-Link API
  * Pay-by-Link
  * Cancel
