...
summary: ' Provisioning API  Connector Routinghttps://documentation.ixopay.com/api/provisioning/connector-routing  Get
  routing'
tags:
- https-gateway-ixopay-com-api-provisioning-getconnectorrouting-connectorguid
- request-https-documentation-ixopay-com-api-provisioning-connector-routing-request-direct-link-request
- path-parameters
- responses-https-documentation-ixopay-com-api-provisioning-connector-routing-responses-direct-link-responses
...
- recurring
- authorization
source_url: https://documentation.ixopay.com/api/provisioning/get-connector-routing
portal: ixopay-dev
updated: '2026-08-17'
related: []
---
...
The returned document is always a valid request body for [Set routing](https://documentation.ixopay.com/api/provisioning/set-connector-routing): fetch it, modify it, and send it back. Every rule node carries a server-assigned `id` — echo these ids when you resubmit to update rules in place.
## Request[​](https://documentation.ixopay.com/api/provisioning/get-connector-routing#request "Direct link to request")
### Path Parameters
**connectorGuid** stringrequired
Identifier of the connector.

## Responses[​](https://documentation.ixopay.com/api/provisioning/get-connector-routing#responses "Direct link to Responses")
  * 200
  * 401
  * 404
  * 422
...
**routing** object
The current routing document. Always a valid request body for [Set routing](https://documentation.ixopay.com/api/provisioning/set-connector-routing).
...
```  * curl
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/provisioning/getConnectorRouting/:connectorGuid' \  
