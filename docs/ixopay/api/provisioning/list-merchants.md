...
```
GET 
## https://gateway.ixopay.com/api/provisioning/listMerchants/:tenantGuid

```

Returns the merchants of the given tenant.
## Request[​](https://documentation.ixopay.com/api/provisioning/list-merchants#request "Direct link to request")
### Path Parameters
**tenantGuid** stringrequired
Identifier of the tenant.


## Responses[​](https://documentation.ixopay.com/api/provisioning/list-merchants#responses "Direct link to Responses")
  * 200
  * 401
  * 422
  * 500
...
**defaultVtRiskRuleSet** integer<int64>
...
**riskAlertEmail** string<email>
**schedulerAlertEmail** string<email>
**technicalEmail** string<email>
**eventNotificationUrl** string<uri>
...
```
curl -L 'https://gateway.ixopay.com/api/provisioning/listMerchants/:tenantGuid' \  
...
Parameters
tenantGuid — pathrequired
[Previous Merchant](https://documentation.ixopay.com/api/provisioning/merchant)[Next Create](https://documentation.ixopay.com/api/provisioning/create-merchant)
  * [](https://documentation.ixopay.com/)
  * [Enterprise](https://documentation.ixopay.com/api/enterprise)
  * Provisioning API
  * [Merchant](https://documentation.ixopay.com/api/provisioning/merchant)
