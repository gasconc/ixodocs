...
```
GET 
## https://gateway.ixopay.com/api/provisioning/listTenants

```

Returns the sub-tenants of the API key's tenant.
## Responses[​](https://documentation.ixopay.com/api/provisioning/list-tenants#responses "Direct link to Responses")
  * 200
  * 401
  * 422
  * 500
...
**mailSenderAddress** string<email>
...
```
curl -L 'https://gateway.ixopay.com/api/provisioning/listTenants' \  
...
Username
Password
[Previous Tenant](https://documentation.ixopay.com/api/provisioning/tenant)[Next Update](https://documentation.ixopay.com/api/provisioning/update-tenant)
  * [](https://documentation.ixopay.com/)
  * [Enterprise](https://documentation.ixopay.com/api/enterprise)
  * Provisioning API
  * [Tenant](https://documentation.ixopay.com/api/provisioning/tenant)
