...
```
POST 
## https://gateway.ixopay.com/api/provisioning/createMerchantUser/:merchantGuid

```

Create a merchant user for the given merchant.
## Request[​](https://documentation.ixopay.com/api/provisioning/create-merchant-user#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/provisioning/create-merchant-user#responses "Direct link to Responses")
  * 200
  * 401
  * 422
  * 500
...
**passwordValidUntil** string<date-time>
...
```
curl -L 'https://gateway.ixopay.com/api/provisioning/createMerchantUser/:merchantGuid' \  
...
[Previous List](https://documentation.ixopay.com/api/provisioning/list-merchant-users)[Next Update](https://documentation.ixopay.com/api/provisioning/update-merchant-user)
  * [](https://documentation.ixopay.com/)
  * [Enterprise](https://documentation.ixopay.com/api/enterprise)
  * Provisioning API
  * [Merchant user](https://documentation.ixopay.com/api/provisioning/merchant-user)
