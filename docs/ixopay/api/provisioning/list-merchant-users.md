...
Parameters
merchantGuid — pathrequired
[Previous Merchant user](https://documentation.ixopay.com/api/provisioning/merchant-user)[Next Create](https://documentation.ixopay.com/api/provisioning/create-merchant-user)
  * [](https://documentation.ixopay.com/)
  * [Enterprise](https://documentation.ixopay.com/api/enterprise)
  * Provisioning API
  * [Merchant user](https://documentation.ixopay.com/api/provisioning/merchant-user)
