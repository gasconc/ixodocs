...
summary: ' Push API'
tags:
- https-gateway-ixopay-com-api-push-apikey-preauthorize
- request-https-documentation-ixopay-com-api-push-preauthorize-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-push-preauthorize-responses-direct-link-responses
- api
- json
- ixopay
- psp
...
# Preauthorize```
POST 
## https://gateway.ixopay.com/api/v3/push/:apiKey/preauthorize

```

Records a preauthorize transaction.
## Request[​](https://documentation.ixopay.com/api/push/preauthorize#request "Direct link to request")
### Path Parameters
...
Reference to the related [Register](https://documentation.ixopay.com/api/transaction/register), [Debit](https://documentation.ixopay.com/api/transaction/debit), or [Preauthorize](https://documentation.ixopay.com/api/transaction/preauthorize) containing the merchant's reference (`transactionId`).
**Example:**`ed0687ad-a876-42fd-bfc2-ce7c91d9700d`
**referenceUuid** string
Reference to the related [Register](https://documentation.ixopay.com/api/transaction/register), [Debit](https://documentation.ixopay.com/api/transaction/debit), or [Preauthorize](https://documentation.ixopay.com/api/transaction/preauthorize) containing the transaction reference (`uuid`).
**Possible values:** `<= 50 characters`
...
## Responses[​](https://documentation.ixopay.com/api/push/preauthorize#responses "Direct link to Responses")
  * 200
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/push/:apiKey/preauthorize' \  
