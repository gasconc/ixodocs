...
summary: ' Push API'
tags:
- https-gateway-ixopay-com-api-push-apikey-payout
- request-https-documentation-ixopay-com-api-push-payout-request-direct-link-request
- path-parameters
- bodyrequired
- api
- json
...
```
POST 
## https://gateway.ixopay.com/api/v3/push/:apiKey/payout

```Records a payout transaction.
note
To send an unreferenced refund, set `extraData.unreferencedRefund` to `"true"`.
## Request[​](https://documentation.ixopay.com/api/push/payout#request "Direct link to request")
### Path Parameters
...
```## Responses[​](https://documentation.ixopay.com/api/push/payout#responses "Direct link to Responses")
  * 200
