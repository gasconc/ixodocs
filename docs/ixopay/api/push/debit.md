...
summary: ' Push API'
tags:
- https-gateway-ixopay-com-api-push-apikey-debit
- request-https-documentation-ixopay-com-api-push-debit-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-push-debit-responses-direct-link-responses
- api
- json
- ixopay
- psp
...
# Debit```
POST 
## https://gateway.ixopay.com/api/v3/push/:apiKey/debit

```

Records a debit transaction.
## Request[​](https://documentation.ixopay.com/api/push/debit#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/push/debit#responses "Direct link to Responses")
  * 200
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/push/:apiKey/debit' \  
