...
tags:
- http-upload-request-https-documentation-ixopay-com-api-batch-upload-http-upload-request-direct-link-http-upload-request
...
## HTTP Upload Request[​](https://documentation.ixopay.com/api/batch-upload#http-upload-request "Direct link to HTTP Upload Request")
### Endpoint[​](https://documentation.ixopay.com/api/batch-upload#endpoint "Direct link to Endpoint")
...
### Payload[​](https://documentation.ixopay.com/api/batch-upload#payload "Direct link to Payload")  
...
## Batch information request[​](https://documentation.ixopay.com/api/batch-upload#batch-information-request "Direct link to Batch information request")
### Endpoint[​](https://documentation.ixopay.com/api/batch-upload#endpoint-1 "Direct link to Endpoint")
`GET https://gateway.ixopay.com/api/v3/batchUpload/{apiKey}/{batchId}/get`
### Payload[​](https://documentation.ixopay.com/api/batch-upload#payload-1 "Direct link to Payload")  
| Field  | Type  | Description  |  
| --- | --- | --- |  
| `apiKey`  | required`string`  | API Key of the Connector  |  
...
```  * [HTTP Upload Request](https://documentation.ixopay.com/api/batch-upload#http-upload-request)
    ...
    * [Response examples](https://documentation.ixopay.com/api/batch-upload#response-examples)
  * [Transaction types](https://documentation.ixopay.com/api/batch-upload#transaction-types)
    * [Debit](https://documentation.ixopay.com/api/batch-upload#debit)
    * [Preauthorize](https://documentation.ixopay.com/api/batch-upload#preauthorize)
    * [Refund](https://documentation.ixopay.com/api/batch-upload#refund)
    * [Payout](https://documentation.ixopay.com/api/batch-upload#payout)
  * [Callback notification](https://documentation.ixopay.com/api/batch-upload#callback-notification)
  * [Batch information request](https://documentation.ixopay.com/api/batch-upload#batch-information-request)
