...
summary: ' Transaction API  Incremental authorization'
tags:
- https-gateway-ixopay-com-api-transaction-apikey-incrementalauthorization
- request-https-documentation-ixopay-com-api-transaction-incremental-authorization-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-incremental-authorization-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-transaction-incremental-authorization-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-transaction-incremental-authorization-callbacks-responses-direct-link-callbacks-responses
- api
- json
source_url: ''
portal: ixopay-dev
...
A follow-up [capture](https://documentation.ixopay.com/api/transaction/capture) transaction may capture the full amount of the initial transaction and all its subsequent incremental authorizations.
warning
The follow-up capture transaction must refer to the initial preauthorize!
## Request[​](https://documentation.ixopay.com/api/transaction/incremental-authorization#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/transaction/incremental-authorization#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
## Callbacks[​](https://documentation.ixopay.com/api/transaction/incremental-authorization#callbacks "Direct link to Callbacks")
  * POST statusChange
```
POST 
## {$request.body#/callbackUrl}
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/transaction/incremental-authorization#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
