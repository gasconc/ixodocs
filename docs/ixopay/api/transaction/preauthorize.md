...
tags:
- https-gateway-ixopay-com-api-transaction-apikey-preauthorize
- request-https-documentation-ixopay-com-api-transaction-preauthorize-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-preauthorize-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-transaction-preauthorize-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-transaction-preauthorize-callbacks-responses-direct-link-callbacks-responses
- api
- sdk
source_url: ''
portal: ixopay-dev
...
# Preauthorize```
POST 
## https://gateway.ixopay.com/api/v3/transaction/:apiKey/preauthorize

```

A Preauthorize reserves the payment amount on the customer's payment instrument.
Depending on the payment method you have up to 7 days until you must [Capture](https://documentation.ixopay.com/api/transaction/capture) the transaction before the authorization expires.
## Request[​](https://documentation.ixopay.com/api/transaction/preauthorize#request "Direct link to request")
### Path Parameters
...
**Possible values:** `non-empty` and `<= 50 characters`
**captureInMinutes** integernullable
**Possible values:** `>= 1`
**extraData** object
...
## Responses[​](https://documentation.ixopay.com/api/transaction/preauthorize#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
## Callbacks[​](https://documentation.ixopay.com/api/transaction/preauthorize#callbacks "Direct link to Callbacks")
  * POST statusChange
```
POST 
## {$request.body#/callbackUrl}
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/transaction/preauthorize#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/transaction/:apiKey/preauthorize' \  
