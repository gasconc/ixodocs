...
Last updated on **Apr 10, 2026**
[Previous Options](https://documentation.ixopay.com/api/transaction/options)[Next Prepare transaction](https://documentation.ixopay.com/api/transaction/prepare-transaction)
  * [](https://documentation.ixopay.com/)
  * Transaction API
  * [Options](https://documentation.ixopay.com/api/transaction/options)
  * List
