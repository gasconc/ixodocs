...
- 3ds
- 3d-secure
source_url: https://documentation.ixopay.com/api/transaction/register
portal: ixopay-dev
updated: '2026-06-29'
related: []
---
...
### Body**required**
Data which is required to process a register. Depending on the adapter, additional fields may be required to be sent as `extraData` and field restrictions may be stricter.
