...
tags:
- https-gateway-ixopay-com-api-transaction-apikey-register
- request-https-documentation-ixopay-com-api-transaction-register-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-register-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-transaction-register-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-transaction-register-callbacks-responses-direct-link-callbacks-responses
- api
- sdk
source_url: ''
portal: ixopay-dev
...
# Register```
POST 
## https://gateway.ixopay.com/api/v3/transaction/:apiKey/register

```

A register transaction registers a customer's payment instrument for future use ([Debit](https://documentation.ixopay.com/api/transaction/debit) or [Preauthorize](https://documentation.ixopay.com/api/transaction/preauthorize)).
## Request[​](https://documentation.ixopay.com/api/transaction/register#request "Direct link to request")
### Path Parameters
...
### Body**required**
Data which is required to process a register
...
## Responses[​](https://documentation.ixopay.com/api/transaction/register#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
`"returnType": "FINISHED"` indicates a successfully completed register transaction.
```
{  
  "success": true,  
...
## Callbacks[​](https://documentation.ixopay.com/api/transaction/register#callbacks "Direct link to Callbacks")
  * POST statusChange
```
POST 
## {$request.body#/callbackUrl}
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/transaction/register#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/transaction/:apiKey/register' \  
