...
tags:
- https-gateway-ixopay-com-api-transaction-apikey-refund
- request-https-documentation-ixopay-com-api-transaction-refund-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-refund-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-transaction-refund-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-transaction-refund-callbacks-responses-direct-link-callbacks-responses
- api
- json
source_url: ''
portal: ixopay-dev
...
# Refund```
POST 
## https://gateway.ixopay.com/api/v3/transaction/:apiKey/refund

```

A refund transaction reverses a payment which was previously performed with [Debit](https://documentation.ixopay.com/api/transaction/debit) or [Capture](https://documentation.ixopay.com/api/transaction/capture).
Depending on the payment method you can even refund only a partial amount of the original transaction amount.
## Request[​](https://documentation.ixopay.com/api/transaction/refund#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/transaction/refund#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
## Callbacks[​](https://documentation.ixopay.com/api/transaction/refund#callbacks "Direct link to Callbacks")
  * POST statusChange
```
POST 
## {$request.body#/callbackUrl}
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/transaction/refund#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/transaction/:apiKey/refund' \  
