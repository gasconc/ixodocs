...
tags:
- https-gateway-ixopay-com-api-transaction-apikey-debit
- request-https-documentation-ixopay-com-api-transaction-debit-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-debit-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-transaction-debit-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-transaction-debit-callbacks-responses-direct-link-callbacks-responses
- api
- sdk
source_url: ''
portal: ixopay-dev
...
# Debit```
POST 
## https://gateway.ixopay.com/api/v3/transaction/:apiKey/debit

```

A Debit performs a complete customer initiated customer-to-merchant payment.
## Request[​](https://documentation.ixopay.com/api/transaction/debit#request "Direct link to request")
### Path Parameters
...
### Body**required**
Data which is required to process a debit transaction.
...
## Responses[​](https://documentation.ixopay.com/api/transaction/debit#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
## Callbacks[​](https://documentation.ixopay.com/api/transaction/debit#callbacks "Direct link to Callbacks")
  * POST statusChange
```
POST 
## {$request.body#/callbackUrl}
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/transaction/debit#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/transaction/:apiKey/debit' \  
