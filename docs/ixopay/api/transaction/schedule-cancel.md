...
tags:
- https-gateway-ixopay-com-api-schedule-apikey-scheduleid-cancel
- request-https-documentation-ixopay-com-api-transaction-schedule-cancel-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-schedule-cancel-responses-direct-link-responses
- api
- json
- ixopay
- authorization
...
```
POST 
## https://gateway.ixopay.com/api/v3/schedule/:apiKey/:scheduleId/cancel
...
## Request[​](https://documentation.ixopay.com/api/transaction/schedule-cancel#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/transaction/schedule-cancel#responses "Direct link to Responses")
  * 200
  * 429
...
```
curl -L 'https://gateway.ixopay.com/api/v3/schedule/:apiKey/:scheduleId/cancel' \  
