...
tags:
- https-gateway-ixopay-com-api-transaction-apikey-void
- request-https-documentation-ixopay-com-api-transaction-void-request-direct-link-request
- path-parameters
- bodyrequired
- api
- json
...
- psp
- authorization
source_url: https://documentation.ixopay.com/api/transaction/void
portal: ixopay-dev
updated: '2026-05-18'
related: []
---
...
```
POST 
## https://gateway.ixopay.com/api/v3/transaction/:apiKey/void

```A void transaction cancels a previously performed authorization made with the [Preauthorize](https://documentation.ixopay.com/api/transaction/preauthorize) method.
## Request[​](https://documentation.ixopay.com/api/transaction/void#request "Direct link to request")
### Path Parameters
...
### Body**required**
Data which is required to process a void. Depending on the adapter, additional fields may be required to be sent as `extraData` and field restrictions may be stricter.
...
```## Responses[​](https://documentation.ixopay.com/api/transaction/void#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
```  * curl
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/transaction/:apiKey/void' \  
