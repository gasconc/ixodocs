...
```Prepare a pre-authorize transaction, will not create a transaction on IXOPAY. Used with very specific payment adapters to prepare a frontend payment widget.
