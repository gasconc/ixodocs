...
tags:
- https-gateway-ixopay-com-api-status-apikey-getbyuuid-uuid
...
```
GET 
## https://gateway.ixopay.com/api/v3/status/:apiKey/getByUuid/:uuid
...
{  
  ...
  "returnData": {  
    ...
    "binBank": "Global Trust ank",  

    "binCountry": "US",  

    "cardUpdatedAt": "2019-09-30 12:00:00",  

    "cardUpdatePausedUntil": "2019-09-30 12:00:00"  
...
```  * curl
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/status/:apiKey/getByUuid/:uuid' \  
