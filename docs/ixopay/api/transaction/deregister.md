...
tags:
- https-gateway-ixopay-com-api-transaction-apikey-deregister
- request-https-documentation-ixopay-com-api-transaction-deregister-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-deregister-responses-direct-link-responses
- api
- json
- 3d-secure
- ixopay
...
# Deregister```
POST 
## https://gateway.ixopay.com/api/v3/transaction/:apiKey/deregister

```

A deregister transaction allows the deletion of a previously registered payment instrument.
## Request[​](https://documentation.ixopay.com/api/transaction/deregister#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/transaction/deregister#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
`"returnType": "FINISHED"` indicates a successfully completed deregister transaction.
```
{  
  "success": true,  
...
:::
  ...
  * CURL
```
curl -L 'https://gateway.ixopay.com/api/v3/transaction/:apiKey/deregister' \  
