...
tags:
- https-gateway-ixopay-com-api-schedule-apikey-scheduleid-pause
- request-https-documentation-ixopay-com-api-transaction-schedule-pause-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-transaction-schedule-pause-responses-direct-link-responses
- api
- json
- ixopay
- authorization
...
```
POST 
## https://gateway.ixopay.com/api/v3/schedule/:apiKey/:scheduleId/pause
...
## Request[​](https://documentation.ixopay.com/api/transaction/schedule-pause#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/transaction/schedule-pause#responses "Direct link to Responses")
  * 200
  * 429
...
```
curl -L 'https://gateway.ixopay.com/api/v3/schedule/:apiKey/:scheduleId/pause' \  
