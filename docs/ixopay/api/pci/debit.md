...
- responses-https-documentation-ixopay-com-api-pci-debit-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-pci-debit-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-pci-debit-callbacks-responses-direct-link-callbacks-responses
...
```  * curl
  ...
  * CURL
```
curl -L -X POST 'https://documentation.ixopay.com/transaction/:apiKey/debit' \  
