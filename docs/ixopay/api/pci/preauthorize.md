...
- request-https-documentation-ixopay-com-api-pci-preauthorize-request-direct-link-request
- responses-https-documentation-ixopay-com-api-pci-preauthorize-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-pci-preauthorize-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-pci-preauthorize-callbacks-responses-direct-link-callbacks-responses
- https-secure-ixopay-com-api-transaction-apikey-preauthorize
- path-parameters
- bodyrequired
- api
...
Depending on the payment method you have up to 7 days until you must [Capture](https://documentation.ixopay.com/api/pci/capture) the transaction before the authorization expires.
## Request[​](https://documentation.ixopay.com/api/pci/preauthorize#request "Direct link to request")
## Responses[​](https://documentation.ixopay.com/api/pci/preauthorize#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
Transaction error response
## Callbacks[​](https://documentation.ixopay.com/api/pci/preauthorize#callbacks "Direct link to Callbacks")
  * POST statusChange
```
POST 
## {$request.body#/callbackUrl}
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/pci/preauthorize#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
...
```  * curl
  ...
  * CURL
```
curl -L -X POST 'https://documentation.ixopay.com/transaction/:apiKey/preauthorize' \  
