...
tags:
- https-secure-ixopay-com-api-transaction-apikey-payout
- request-https-documentation-ixopay-com-api-pci-payout-request-direct-link-request
- path-parameters
- bodyrequired
- responses-https-documentation-ixopay-com-api-pci-payout-responses-direct-link-responses
- callbacks-https-documentation-ixopay-com-api-pci-payout-callbacks-direct-link-callbacks
- request-body-callbackurl
- callbacks-responses-https-documentation-ixopay-com-api-pci-payout-callbacks-responses-direct-link-callbacks-responses
- api
- json
source_url: ''
portal: ixopay-dev
...
# Payout```
POST 
## https://secure.ixopay.com/api/v3/transaction/:apiKey/payout
...
## Request[​](https://documentation.ixopay.com/api/pci/payout#request "Direct link to request")
### Path Parameters
...
## Responses[​](https://documentation.ixopay.com/api/pci/payout#responses "Direct link to Responses")
  * 200
  * 400
  * 422
...
## Callbacks[​](https://documentation.ixopay.com/api/pci/payout#callbacks "Direct link to Callbacks")
  * POST statusChange
...
## Callbacks Responses[​](https://documentation.ixopay.com/api/pci/payout#callbacks-responses "Direct link to Callbacks Responses")
  * 200
  * 500
...
```
curl -L 'https://secure.ixopay.com/api/v3/transaction/:apiKey/payout' \  
