...
Remember to accurately include all necessary information for successful risk checks with Forter. If you encounter issues, review your connector configuration or the extra data you're providing.
Last updated on **Apr 10, 2026**
[Previous External risk checks](https://documentation.ixopay.com/docs/reference/features/risk-checks/external)[Next Dynamic currency conversion (DCC)](https://documentation.ixopay.com/docs/reference/features/dcc)
