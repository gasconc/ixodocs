...
tags:
- success-notification-https-documentation-ixopay-com-docs-reference-integration-callbacks-notification-types-success-notification-direct-link-success-notification
- network-token-notification-https-documentation-ixopay-com-docs-reference-integration-callbacks-notification-types-network-token-notification-direct-link-network-token-notification
- api
- tokenization
- ixopay
- chargeback
...
{  
  ...
  "purchaseId": "20260623-d94c0d72f3a36e21f16e",  
...
{  
  ...
  "purchaseId": "20260623-313f381aef908f4558e3",  
  ...
  "chargebackData": {  
    ...
    "chargebackDateTime": "2026-06-25T07:56:38Z"  
...
{  
  ...
  "chargebackReversalData": {  
    ...
    "reversalDateTime": "2026-06-24T07:56:38Z"  
...
```In the example, the notification indicates that the last card update occurred on `June 1st, 2021`, and the result of the update was `updated`. The `returnData` field of type `cardData` contains the updated card information, such as the card type, cardholder name, expiry date, BIN details, and more.
...
{  
  ...
  "extraData": {  
    ...
    "lastNetworkTokenUpdateDate": "2026-06-24T07:56:38Z",  
