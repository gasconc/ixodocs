...
This function is deprecated in favor of [`cvvOn('input', callbackFunction)`](https://documentation.ixopay.com/docs/reference/integration/payment.js/methods#cvvon).
Last updated on **Apr 10, 2026**
[Previous Hosted fields — payment.js](https://documentation.ixopay.com/docs/reference/integration/payment.js)[Next Error codes](https://documentation.ixopay.com/docs/reference/integration/payment.js/error-codes)
