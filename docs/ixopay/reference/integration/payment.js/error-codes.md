...
summary: ' Hosted fields — payment.jshttps://documentation.ixopay.com/docs/reference/integration/payment.js  Error
  codes'
tags:
- card-number-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-card-number-direct-link-card-number
- empty-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-empty-direct-link-empty
- invalid-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-invalid-direct-link-invalid
- cvv-cvc-code-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-cvvcvc-code-direct-link-cvv-cvc-code
- expiration-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-expiration-direct-link-expiration
...
- expiration-month-invalid-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-expiration-month-invalid-direct-link-expiration-month-invalid
- expiration-year-empty-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-expiration-year-empty-direct-link-expiration-year-empty
- expiration-year-invalid-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-expiration-year-invalid-direct-link-expiration-year-invalid
- card-expired-https-documentation-ixopay-com-docs-reference-integration-payment-error-codes-card-expired-direct-link-card-expired
source_url: ''
portal: ixopay-dev
updated: '2026-04-10'
related: []
