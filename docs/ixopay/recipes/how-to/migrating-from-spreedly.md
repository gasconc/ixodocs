...
Last updated on **Apr 10, 2026**
[Previous How to add a second PSP for fail-safe payments](https://documentation.ixopay.com/docs/recipes/how-to/dual-psp-failure-safety)[Next How to use TokenEx universal tokens](https://documentation.ixopay.com/docs/recipes/how-to/use-tokenex-universal-tokens)
