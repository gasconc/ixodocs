...
tags:
- chargebeehttps-docs-congrify-com-integrations-chargebee-chargebee
- connect-chargebeehttps-docs-congrify-com-integrations-chargebee-connect-chargebee
- required-access-credentialshttps-docs-congrify-com-integrations-chargebee-required-access-credentials
- importing-historical-datahttps-docs-congrify-com-integrations-chargebee-importing-historical-data
- available-reportshttps-docs-congrify-com-integrations-chargebee-available-reports
- api
- ixopay
- recurring
- subscription
...
# [![Congrify Documentation Portal](https://congrify.com/wp-content/uploads/logo-congrify.svg)](https://docs.congrify.com/)
  ...
  * **Integrations**
    ...
    * [Chargebee](https://docs.congrify.com/#/Integrations/chargebee "Chargebee")
      * [How to connect with Chargebee](https://docs.congrify.com/#/Integrations/chargebee?id=how-to-connect-with-chargebee "How to connect with Chargebee")
        * [Required access credentials](https://docs.congrify.com/#/Integrations/chargebee?id=required-access-credentials "Required access credentials")
        * [Importing Historical Data](https://docs.congrify.com/#/Integrations/chargebee?id=importing-historical-data "Importing Historical Data")
      * [Available Reports](https://docs.congrify.com/#/Integrations/chargebee?id=available-reports "Available Reports")
...
## [Chargebee](https://docs.congrify.com/#/Integrations/chargebee?id=chargebee)
## [About Chargebee](https://docs.congrify.com/#/Integrations/chargebee?id=about-chargebee)
...
## [How to connect with Chargebee](https://docs.congrify.com/#/Integrations/chargebee?id=how-to-connect-with-chargebee)
To connect with Chargebee please contact Congrify's support.
## [Required access credentials](https://docs.congrify.com/#/Integrations/chargebee?id=required-access-credentials)
  1. Name The name of Chargebee's Account
  2. API Key The API Key on the Chargebee platform to ingest data for
  3. Site The URL of your Chargebee account.

## [Importing Historical Data](https://docs.congrify.com/#/Integrations/chargebee?id=importing-historical-data)
During the onboarding process with Congrify, you can import historical data from Chargebee. Please reach out to Congrify's team to confirm which data can be historically downloaded.
## [Available Reports](https://docs.congrify.com/#/Integrations/chargebee?id=available-reports)
The following reports are available for the Chargebee integration and will provide the necessary data for a successful integration with Congrify. Please ensure that you select these reports as a minimum when configuring your Chargebee connection:
  * Credit Note report
  * Invoice Report
  * Order Report
  * Subscription Report
