...
tags:
- getting-startedhttps-docs-congrify-com-integrations-gettingstarted-getting-started
- psp-connections-congrifyhttps-docs-congrify-com-integrations-gettingstarted-psp-connections-congrify
- available-psp-connectionshttps-docs-congrify-com-integrations-gettingstarted-available-psp-connections
- ixopay
- psp
- chargeback
- merchant
...
# [![Congrify Documentation Portal](https://congrify.com/wp-content/uploads/logo-congrify.svg)](https://docs.congrify.com/)
  ...
  * **Integrations**
    * [Getting Started](https://docs.congrify.com/#/Integrations/GettingStarted "Getting Started")
      * [Available PSP connections](https://docs.congrify.com/#/Integrations/GettingStarted?id=available-psp-connections "Available PSP connections")
...
## [Getting Started](https://docs.congrify.com/#/Integrations/GettingStarted?id=getting-started)
## [How to set up PSP connections with Congrify](https://docs.congrify.com/#/Integrations/GettingStarted?id=how-to-set-up-psp-connections-with-congrify)
Congrify is a self-service, no-code platform that enables seamless integration with various payment service providers.
To get started, log into your Congrify account and navigate to the "Connections" section. From there, you can activate the integration for the payment service provider you are using to process payments.
...
![Alt text](https://docs.congrify.com/Images/Connections_tab.png)
## [Available PSP connections](https://docs.congrify.com/#/Integrations/GettingStarted?id=available-psp-connections)
Congrify currently offers native integrations with the following Payment Service Providers:  
| PSP  | URL  |  
| --- | --- |  
| **Adyen**  |   |  
| **Braintree**  |   |  
