...
**Test URI** : <https://test-api.tokenex.com/v2/ThreeDSecure/Authentications>  
**Prod URI** : <https://api.tokenex.com/v2/ThreeDSecure/Authentications>
...
Last updated on **Apr 10, 2026**
[Previous TokenEx : EMVCo Property Mapping](https://documentation.ixopay.com/modules/docs/tokenex/tokenex-emvco-property-mapping)[Next 3DS FAQs](https://documentation.ixopay.com/modules/docs/tokenex/3ds-faqs)
