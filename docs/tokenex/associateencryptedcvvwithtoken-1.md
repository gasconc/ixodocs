...
Last updated on **Apr 10, 2026**
[Previous TokenizeFromEncryptedValues](https://documentation.ixopay.com/modules/docs/tokenex/tokenizefromencryptedvalue-pci)[Next TGAPI v2 - The Basics](https://documentation.ixopay.com/modules/docs/tokenex/tgapi-v2-the-basics)
Send Feedback
Send Feedback
  * [](https://documentation.ixopay.com/modules/)
  * TokenEx API v1
