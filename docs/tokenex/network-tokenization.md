...
## What are the benefits of Network Tokenization?[​](https://documentation.ixopay.com/modules/docs/tokenex/network-tokenization#benefits-of-network-tokenization "Direct link to What are the benefits of Network Tokenization?")
...
## How do I use Network Tokens within the Transparent Gateway API?[​](https://documentation.ixopay.com/modules/docs/tokenex/network-tokenization#using-network-tokens-within-the-transparent-gateway-api "Direct link to How do I use Network Tokens within the Transparent Gateway API?")
...
## How do I test Network Tokenization?[​](https://documentation.ixopay.com/modules/docs/tokenex/network-tokenization#testing-network-tokenization "Direct link to How do I test Network Tokenization?")
